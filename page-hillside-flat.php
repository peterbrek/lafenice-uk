...
$project_name = 'budai-lakas';
$project_folder = '03_budai-lakas';
$page_description = '';
$page_keywords = '';
include('header.php');
?>
                ...
                <div class="row">
                    ...
                    <!-- <div class="col-sm-5">
                        ...
                        <!-- <div class="project-description">
                            <p>A fémes csillogás és a letisztult formák jellemzik ezt a teljesen felújított lakást.</p>
							<p>A nappaliban a JAB Carlucci fényáteresztő függönye ragyog és a dekorok a  Prestigious Textiles bársony anyaga, amin nyomott ezüst minták csillannak meg.
A szeretett ülőgarnitúrát, ágyakat és székeket nem cseréltük le csak újra kárpitoztuk a Saum & Viebahn bársony és a Designers Guild kárpit anyagaival.
Casamance és a Saum & Viebahn  függönyei díszítik a többi helységet is.
A JAB Infinity és a Designers Guild szőnyegek meleggé varázsolják az otthont.
