<?php
$page_title = 'Lakeside house';
$project_name = 'toparti-nyaralo';
$project_folder = '04_toparti-nyaralo';
$page_description = '';
$page_keywords = '';
include('header.php');
?>
                ...
                <div class="row">
                    ...
                    <!-- <div class="col-sm-5">
                        ...
                        <!-- <div class="project-description">
                            <p>Hegyoldalba épült ház, gyönyörű kilátással.</p>
							<p>A külső árnyékolást szélérzékelős zsalúziák felszerelésével oldottuk meg.
A nappaliban, és a hálószobákban csak fényzáró anyagból (blackout) függönyök lettek megvarrva, amit a motoros karnis könnyen mozgat.
Mellékhelységek: Saum & Viebahn Script anyagából készített római rolók.
