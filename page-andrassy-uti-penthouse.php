<?php
$page_title = 'Penthouse on Andrássy Avenue';
$project_name = 'andrassy-uti-penthouse';
$project_folder = '02_andrassy-uti-penthouse';
$page_description = '';
$page_keywords = '';
include('header.php');
?>
                ...
                <div class="row">
                    ...
                    <!--<div class="col-sm-5">
                        ...
                        <!--<div class="project-description">
                            <p>Az Andrássy úti penthouse egy patinás bérház tetején épült, modern 2 szintes lakás.</p>
<p>A galériás nappaliban belső sínes rúdkarnisokat szereltünk az oldalfalakra és a Saum & Viebahn Merle natúr színű strukturált fényáteresztő anyagát varrtuk meg függönynek, és római rolóknak. Az ebédlő és a dolgozósarok falait a Cole & Son tapétái díszitik.
Az emeleten a hálószobákban a tetőtéri, különleges formájú ablakokra pliszét szereltünk, mely az árnyékolást segíti ,a falakon Christian Lacroix tapétákat használtunk.
Az otthonba a szőnyegeket a Designers Guild-től rendeltük.</p>
                        </div>
                    </div>
