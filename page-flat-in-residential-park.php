<?php
$page_title = 'Flat in Residential Park';
$project_name = 'cordia-galerias-lakas';
$project_folder = '05_cordia-galerias-lakas';
$page_description = '';
$page_keywords = '';
include('header.php');
?>
                ...
                <div class="row">
                    ...
                    <!-- <div class="col-sm-5">
                        ...
                        <!-- <div class="project-description">
                            <p>Belső 2 szintes, galériás lakás.</p>
							<p>A motoros karnis az 5 méteres magasságban könnyen mozgatja a JAB dekoranyagból készült függönyöket.
A falakon a Wall&Deco, Christian Lacroix és a Harlequin tapétái.
A szobákban a függönyök harmonizálnak a kiegészítőkkel. A díszpárnák és ágytakarók egyedi méretre készültek.
A modern konyha ablakain pliszé az egyszerűség kedvéért.
