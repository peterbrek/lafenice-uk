                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <ul class="gallery-inner">
                            ...
                            <li>
                                <a href="../assets/img/portfolio/<?=$project_folder ?>/<?=$project_name ?>-9.jpg" data-lightbox="example-set">
                                    <img src="../assets/img/portfolio/<?=$project_folder ?>/<?=$project_name ?>-9b.jpg" alt="<?=$page_title ?>">
                                </a>
                            </li> 

                            <li>
                                <a href="../assets/img/portfolio/<?=$project_folder ?>/<?=$project_name ?>-10.jpg" data-lightbox="example-set">
                                    <img src="../assets/img/portfolio/<?=$project_folder ?>/<?=$project_name ?>-10.jpg" alt="<?=$page_title ?>">
                                </a>
                            </li> 

                            <li>
                                <a href="../assets/img/portfolio/<?=$project_folder ?>/<?=$project_name ?>-11.jpg" data-lightbox="example-set">
                                    <img src="../assets/img/portfolio/<?=$project_folder ?>/<?=$project_name ?>-11b.jpg" alt="<?=$page_title ?>">
                                </a>
                            </li> 
