<?php
$page_title = 'Countryside family house';
$project_name = 'videki-csaladi-haz';
$project_folder = '01_videki-csaladi-haz';
$page_description = '';
$page_keywords = '';
include('header.php');
?>
                ...
                <div class="row">
                    ...
                    <!-- <div class="col-sm-5">
                        ...
                        <!-- <div class="project-description">
                            <p>Kisgyermekes család háza, előtérbe helyezve a gyerekek és a kényelem szempontjait.</p>
							<p>Külső árnyékolás hiányában, a sötétítő függönyt, JAB Seclusive, gyűrt struktúrájú anyagot, blackouttal béleltük, ami kizárja a fényt,
előtte könnyű, lenes hatású fényáteresztő függöny omlik a padlóra. Az étkező és a konyha helyiségekben az osztrák Leha cég fémreluxái kerültek az ablakra. A hálószobában a nappalival megegyező anyagot, eltérő színben használtuk fel.
A gyerekeknél a tapéta, a szőnyeg és a függönyök anyagai Designers Guild és Harlequin termékek.
Wall&Deco tapéta a fürdőben és a hálóban is.
							</p>
                        </div>
                    </div>
