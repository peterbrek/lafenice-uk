<?php
$page_title = 'Condominium by the Danube in Budapest';
$project_name = 'dunaparti-lakoparki-lakas';
$project_folder = '24_dunaparti-lakoparki-lakas';
$page_description = '';
$page_keywords = '';
include('header.php');
?>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-5">
                        ...
                        <div class="project-description">
                            <p>Our client chose our well-beloved Trend Design furniture package for their apartment. Due to the big size of the apartment (three bedrooms) we were striving to complete our design with several other home accessories that match, for example, the  desk and chair, etc. By using specific colours for the bedroom and living room curtains we tried to set off the fact that the apartment is overlooking the water, thus creating a unique mood for the whole space.
